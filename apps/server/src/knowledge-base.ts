...
David has led design teams at globally recognised financial institutions including HSBC, BlackRock, Coutts & Co (NatWest Group), Deutsche Bank, Schroders, and Barclays, as well as high-growth SaaS companies like Cognism that scaled from $20M to $80M ARR under his design leadership.
...
HSBC (2008-2012) & Barclays Wealth (2012-2013) - Senior UX / UX Lead:
- Managed UK commercial digital presence for 34 million visits per year at HSBC
- Optimised MVT/AB conversion rates to meet digital sales goals
- Improved customer journeys across international banking platforms at Barclays

BlackRock (2006-2008) - AVP, Senior Intl. Digital Marketing Manager:
- Managed digital transformation across 21 countries (EMEA, APAC, and LATAM)
- Established global design standards and WCAG accessibility frameworks

TSB Bank (2013-2015) - UX Lead:
- Delivered branch locator and digital-only current account
- Drove customer acquisition via multi-million pound campaigns

Deutsche Bank (2016) - UX Lead:
- Led design of global HR intranet
- Set up mobile UX laboratories in UK and Germany
...
This global experience across major financial institutions shaped David's understanding of how design delivers across cultures and regulatory frameworks.`,
        category: 'achievement',
        keywords: ['tsb', 'barclays', 'hsbc', 'blackrock', 'avp', 'a/b testing', 'cro', 'conversion', 'emea', 'apac', 'latam', 'wcag', 'accessibility', 'tsb', 'deutsche bank']
    },
...
These interests complement his professional experience working across global markets and managing distributed teams at Deutsche Bank.`,
        category: 'bio',
...
2. Regulated Industries: David has deep experience in private banking (Coutts), wealth management (Schroders), and enterprise banking (BlackRock, HSBC, Deutsche Bank, Barclays). He understands compliance requirements and stakeholder complexity in financial services.

3. Global Scale: David has led design initiatives across global markets (including a 21-country transformation at BlackRock across EMEA, APAC, and LATAM). He understands how design delivers across cultures and regulatory frameworks, and has proven expertise managing distributed teams.`,
        category: 'philosophy',
        keywords: ['ai fluency', 'regulated industries', 'global scale', 'blackrock', 'compliance', '21 countries', 'cross-cultural', 'asia pacific', 'emea', 'latam', 'private banking', 'wealth management']
    },
...
Cognism (Jul 2022 - Jun 2024):
- Built first Product Design function during 4x growth ($20M→$80M ARR)
- Lifted NPS from -16 to +12 (ease of use cited as main driver)
- 100% team retention over two years; onboarding became company benchmark

Coutts (Jun 2020 - Jul 2022):
- Scaled team 5→15 specialists (UX, UI, Research)
- Directed launch of mobile app (4.2★ rating)
- Figma transformation for 280+ designers (£400K+ annual savings)

HSBC Kinetic (May 2019 - Nov 2019):
- Led design for multi-billion pound transformation
- 35% adoption in 6 months (target was 25%)
- Shared pattern library with 80%+ reuse

Schroders (2016-2019):
- UX Lead for Wealth & Investments
- Unified 3 legacy systems into single platform

Earlier Career:
- AVP at BlackRock (2006-08): 21-country transformation
- Deutsche Bank (2016): HR intranet & UK/Germany mobile labs
- TSB Bank (2013-15): Branch locator & digital accounts
- Barclays Wealth (2012-13): CRO & intentional banking
- HSBC (2008-12): Managed 34M+ annual visits commercial presence`,
        category: 'achievement',
        keywords: ['achievements', 'arr', '20m to 80m', 'retention', '100%', 'team scaling', '200%', '14 billion', 'design system']
    }
];
...
- BlackRock: Managed digital transformation across 21 countries (AVP level)
- Design systems: Implemented comprehensive systems at both Cognism and Coutts
- Global experience: Led multi-market digital transformations and managed distributed teams
