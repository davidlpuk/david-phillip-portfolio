...
const capabilityGroups = [
  ...
  },
  {
    ...
    icon: Globe,
    capabilities: [
      "B2C and B2B platforms serving 21 countries (Schroders)",
        ...
        <div className="max-w-6xl mx-auto px-4 md:px-6 lg:px-8 py-16 md:py-20 lg:py-28">
          <div className="mb-12 md:mb-16 max-w-3xl mx-auto text-center px-4 md:px-0">
            ...
            <p className="font-sans text-base md:text-lg leading-relaxed" style={{ color: 'var(--text-inverse-secondary)' }}>
              I've built design teams across Schroders, HSBC, Coutts, and Cognism—from scaling 15-person orgs to shipping production code myself. Most leaders choose strategy or craft. I refuse to. Great design leadership is about clarity: knowing what to build, aligning the right people, and moving fast from insight to shipped product. No handoffs. No gaps.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-6xl mx-auto px-4 md:px-6 lg:px-8 py-16 md:py-20 lg:py-24">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-12">
            <div className="max-w-xl">
              ...
              <h3 className="font-display text-6xl font-bold leading-6xl mb-2" style={{ color: 'var(--text-inverse-primary)' }}>
                The Leadership Framework
              </h3>
              <p className="font-serif text-2xl font-medium italic mb-6" style={{ color: 'var(--text-inverse-primary)' }}>
                Scaling with High-Performance & Zero Attrition
              </p>
