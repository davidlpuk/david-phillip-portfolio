...
const caseStudies: readonly CaseStudy[] = [
  ...
  },
  {
    ...
    category: "SaaS",
    description: "Internal R&D Lab built an AI platform providing PhD-level UX feedback in 30 seconds, with spatial annotation and Tailwind code solutions.",
    metrics: [
...
const isProtected = (slug: string): boolean =>
  ["coutts", "hsbc", "hsbc-kinetic", "cognism"].includes(slug);
...
export default function SelectedWorkFiltered() {
  // Direct usage of case studies, no filtering logic needed
