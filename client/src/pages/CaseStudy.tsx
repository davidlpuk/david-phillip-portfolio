...
import { isCaseStudyProtected } from "@/config/case-study-passwords";
...
const caseStudiesData: CaseStudiesData = {
    ...
    schroders: {
        ...
        subtitle: "Creating a unified digital experience for wealth management",
        role: "End-to-End Digital Transformation Consultant",
        period: "2016–2018",
        thumbnail: "/images/regulatory-collaboration.png",
        summary: "Schroders' Private Banking division had fragmented legacy systems creating inconsistent experiences that undermined their premium service proposition. As the lead consultant, I owned the end-to-end digital transformation across all client-facing touchpoints. I led a team of 6 specialists through a 2-year transformation that unified 12 disparate systems into a single digital platform, delivered 65% increase in customer engagement, and established the foundation for Schroders' ongoing digital evolution.",
        tldrTakeaways: [
            "Unified 12 disparate legacy systems into a single digital platform",
            "65% increase in customer engagement across all digital touchpoints",
            "3x increase in digital transactions within 12 months of launch",
            "Established design governance that persisted beyond the engagement"
        ],
        metrics: [
            { label: "Customer Engagement", value: "+65%", description: "Across all digital touchpoints" },
            { label: "Digital Transactions", value: "3x", description: "Within 12 months of launch" },
            { label: "Client Retention", value: "94%", description: "Post-transformation (up from 89%)" },
            { label: "Systems Unified", value: "12→1", description: "Legacy platforms consolidated" },
            { label: "Mobile Adoption", value: "+48%", description: "Active mobile users post-launch" }
        ],
        meta: {
            role: "Digital Transformation Consultant",
            date: "2016-2018",
            stakeholders: ["Private Banking Executive", "Investment Teams", "Technology", "Compliance", "Operations"],
            teamSize: "6 specialists (2 UX, 2 UI, 1 Research, 1 Technical Lead)"
        },
        sections: [
            {
                id: "challenge",
                ...
                content: [
                    {
                        subtitle: "Fragmented Legacy Systems",
                        text: "Schroders' Private Banking division had grown through acquisition, resulting in 12 disparate legacy systems that created wildly inconsistent experiences. A client might use one portal for their portfolio, a different one for transactions, and paper-based processes for complex transactions. This fragmentation wasn't just inconvenient — it undermined the premium service proposition Schroders was known for."
                    },
                    {
                        subtitle: "Client Expectations",
                        text: "High-net-worth clients expected digital experiences that matched the sophistication of their relationship managers. They were accustomed to seamless experiences from consumer apps and modern fintech services. The gap between Schroders' investment expertise and their digital experience was becoming a competitive liability, particularly with younger inheritors of wealth."
                    },
                    {
                        subtitle: "Technical Complexity",
                        text: "The challenge wasn't just UX — it was architecture. Each legacy system had been built at different times with different technologies. Migrating data, maintaining service continuity, and ensuring regulatory compliance while fundamentally transforming the experience required careful orchestration across multiple stakeholders."
                    }
                ]
            },
            {
                ...
                content: [
                    {
                        ...
                        text: "I was brought in as the lead consultant to own the end-to-end digital transformation. This meant establishing the vision, building the team, and orchestrating the complex stakeholder alignment required. I reported directly to the Private Banking Executive and partnered closely with Technology and Compliance leadership."
                    },
                    {
                        subtitle: "Team Leadership",
                        text: "I led a team of 6 specialists across UX, UI, research, and technical design. Given the engagement model, I had to build trust quickly — the team included both consultants and internal Schroders staff who were understandably skeptical about outsiders leading their transformation."
                    },
                    {
                        subtitle: "Strategic Decisions",
                        text: "I made the call to build a unified platform rather than integrate the existing systems. This was controversial — integration would have been faster and cheaper. But I argued that the technical debt and inconsistent UX patterns meant integration would create a better-than-before experience, not a market-leading one. We secured approval for the full rebuild approach."
                    }
                ]
            },
            {
                ...
                items: [
                    {
                        number: "1",
                        title: "Build unified platform vs. integrate legacy",
                        text: "Technology leadership wanted to integrate the 12 systems incrementally — lower risk, faster delivery. I pushed back, arguing that integration would create a 'least common denominator' experience that didn't solve the fundamental problem. I proposed a phased migration: build new unified platform, parallel-run with legacy systems, then migrate clients progressively. This 2-year investment required executive sponsorship but created the breakthrough experience Schroders needed.",
                        image: "/images/coutts-wireframe-progression.svg",
                        caption: "Platform evolution: from 12 systems to unified experience"
                    },
                    {
                        number: "2",
                        title: "Portfolio-first information architecture",
                        text: "The existing systems were transaction-first, which made sense operationally but confused clients about their wealth. I advocated for portfolio-first IA that showed clients their total wealth picture immediately, with transactions and activity as supporting information. This required significant pushback from Operations but was validated through research and ultimately adopted."
                    },
                    {
                        number: "3",
                        title: "Investment expertise as design differentiator",
                        text: "Rather than making Schroders look like a consumer fintech, I positioned their investment expertise as the design differentiator. The platform would have sophisticated data visualisation, clear explanatory content, and transparency that reflected their investment approach. This meant rejecting common 'best practices' that would have made the platform feel generic."
                    },
                    {
                        number: "4",
                        title: "Parallel-run migration approach",
                        text: "I proposed a parallel-run approach where the new platform operated alongside legacy systems for 6 months. Clients could migrate when ready, and we monitored issues in production before mass migration. This reduced risk significantly and allowed us to iterate based on real usage data."
                    }
                ]
            },
            {
                ...
                content: [
                    {
                        subtitle: "Research Approach",
                        text: "Given the regulatory environment and the nature of UHNW clients, I established a research program that combined direct interviews with relationship manager observations. We couldn't always speak directly to clients about their wealth, but we could observe how they interacted with the existing systems and interview them about their broader digital expectations."
                    },
                    {
                        subtitle: "Key Insights",
                        text: "Research revealed that clients didn't want a 'Bloomberg terminal' experience — they wanted clarity and confidence. The sophisticated data that Schroders used internally needed to be translated into visualisations that clients could understand quickly. They wanted to trust the platform the way they trusted their relationship manager."
                    },
                    {
                        subtitle: "Competitive Benchmarking",
                        text: "I benchmarked against premium banking, wealth management, and consumer apps to understand expectations. The insight: clients compared Schroders to their best digital experiences, not just other wealth managers. Meeting those expectations required a fundamentally different approach than industry-standard wealth management platforms."
                    }
                ]
            },
            {
                ...
                content: [
                    {
                        ...
                        text: "I established a comprehensive design system that could scale across the unified platform. Given the 2-year timeline, this investment paid dividends — consistency improved, development accelerated, and the platform felt cohesive despite being built by multiple teams over time.",
                        image: "/images/coutts-design-system.svg",
                        caption: "Design system components for wealth management"
                    },
                    {
                        subtitle: "Design Governance",
                        text: "I established design review processes and governance that ensured consistency across teams. This included regular design critiques, component reviews, and documentation that made it easy for developers to build consistently. The governance model persisted beyond my engagement."
                    }
                ]
            },
            {
                ...
                content: [
                    {
                        subtitle: "User Metrics",
                        text: "Customer engagement increased 65% across all digital touchpoints. Digital transactions grew 3x within 12 months of launch. Client retention improved to 94% (up from 89%). Mobile adoption reached 48% of active users, far exceeding the 20% target.",
                        image: "/images/coutts-impact-metrics.svg",
                        caption: "Impact metrics: 65% engagement increase, 3x transactions, 94% retention"
                    },
                    {
                        subtitle: "Platform Consolidation",
                        text: "Successfully unified 12 legacy systems into a single digital platform. This reduced operational complexity, maintenance costs, and the risk of inconsistent experiences. The consolidated architecture also enabled faster iteration going forward."
                    },
                    {
                        subtitle: "Organisational Change",
                        text: "Design became a respected function within Private Banking. The processes and governance I established persisted beyond the engagement. The team I built and mentored continued the transformation work after I departed."
                    }
                ]
            },
            {
                ...
                content: [
                    {
                        subtitle: "What I'd Do Differently",
                        text: "I underestimated the change management required. The internal team was accustomed to working in a particular way, and my consultant status created natural skepticism. I should have invested more in relationship building early on, even if it slowed initial progress. The parallel-run approach was right, but I should have communicated the timeline and expectations more clearly to stakeholders."
                    },
                    {
                        subtitle: "What Worked",
                        text: "The unified platform decision was the right call — it created a genuinely different experience rather than a marginally better one. The research programme built institutional knowledge that informed decisions beyond the platform build. Building credibility through early wins with the relationship managers created advocates who helped with client adoption."
                    },
                    {
                        subtitle: "What I'd Do Sooner",
                        text: "I should have established design review as mandatory from day one. Initially, I was too accommodating of 'just this once' exceptions when under deadline pressure. This created some inconsistencies that took effort to resolve."
                    }
                ]
            },
            {
                ...
                items: [
                    {
                        title: "Build for the experience you want, not the experience you have",
                        text: "Integration creates 'better than before' — rebuilding creates 'better than anyone else.' If the strategic goal is transformation, the investment in a unified platform is worth it."
                    },
                    {
                        title: "Trust takes longer to build with internal teams",
                        text: "As an external consultant, I had to work harder to build credibility with internal teams. Investing in relationships early paid dividends throughout the engagement."
                    },
                    {
                        title: "Research in regulated environments requires creativity",
                        text: "Direct client access wasn't always possible. Combining interviews, observations, and relationship manager insights created a complete picture that informed confident design decisions."
                    },
                    {
                        title: "Design governance enables scale",
                        text: "With multiple teams working on a unified platform, consistent design requires deliberate governance. The processes I established made it possible to maintain quality at speed."
                    }
                ]
            }
        ]
    ...
    cognism: {
        company: "Cognism",
        title: "Building a World-Class UX Team",
    ...
    "hsbc-kinetic": {
        ...
        title: "Award-Winning Business Banking",
        subtitle: "Led UX design for HSBC's mobile-first business banking app across lending products",
        role: "UX Lead | Business Lending Products",
        period: "May 2019–November 2019",
        thumbnail: "/images/case-study-hero-hsbc.png",
        summary: "Led UX design for HSBC's mobile-first business banking app, managing 3 designers across lending products in a multi-billion-pound initiative. Established consistent design patterns across multiple consultant teams, delivered validated prototypes, and mentored team through rapid delivery. The app won 'Best App Based Business Bank Account' for four consecutive years (2022-2025).",
        tldrTakeaways: [
            "Led team of 3 designers across Business Credit Cards, Small Business Loans, and Marketplace",
            "Delivered validated prototypes within 5 months of hire",
            "Established consistent design patterns across multiple consultant teams",
            "App won 'Best App Based Business Bank Account' for 4 consecutive years (2022-2025)"
        ],
        metrics: [
            { label: "Award Years", value: "4 Years", description: "Best App Based Business Bank Account (2022-2025)" },
            { label: "Products Delivered", value: "3 Core", description: "Business Credit Cards, Small Business Loans, Marketplace" },
            { label: "Delivery Time", value: "5 Months", description: "From hire to validated prototype" },
            { label: "Team Size", value: "3", description: "Designers managed" },
            { label: "Team Retention", value: "100%", description: "All designers retained and developed" }
        ],
        meta: {
            role: "UX Lead - Business Lending Products",
            date: "May 2019 – November 2019",
            stakeholders: ["Product Managers", "Researchers", "Engineering Teams", "Multiple Consultancies", "HSBC Leadership"],
            teamSize: "3 designers (direct reports)"
        },
        sections: [
            {
                id: "challenge",
                ...
                content: [
                    {
                        subtitle: "Strategic Problem",
                        text: "HSBC faced a strategic problem: digital challengers like Tide and Starling had raised the bar for SME banking. Small business owners compared business banking to consumer apps — and HSBC's legacy platform couldn't compete. The solution: HSBC Kinetic, a ground-up rebuild for sole traders and single-director companies. Mobile-first, simple, and competitive with neo-banks while maintaining enterprise banking capabilities."
                    },
                    {
                        subtitle: "Key UX Problems",
                        text: "The legacy app had fundamental issues: Information overload from years of feature additions, navigation failures with frozen screens and hidden buttons, text-heavy interfaces that confused users, unclear onboarding where users didn't know what to prepare, and poor progress indication causing uncertainty about application status.",
                        image: "/images/coutts-before-after.svg",
                        caption: "Legacy interface (left) versus redesigned Kinetic experience (right)"
                    },
                    {
                        subtitle: "Organisational Complexity",
                        text: "Challenge: Build a modern app while coordinating multiple product teams, consultants, and stakeholders across a complex organisation."
                    }
                ]
            },
            {
                ...
                content: [
                    {
                        subtitle: "Leadership Scope",
                        text: "UX Lead within HSBC's UX leadership team, managing 3 designers across Business credit cards (application, management), Small business loans (eligibility, applications), and Marketplace (third-party API integrations).",
                    ...
                    },
                    {
                        ...
                        text: "Responsibilities included stakeholder management across product managers, researchers, engineering teams, and multiple consultancies, while mentoring designers through high-stakes delivery."
                    }
                ]
            },
            {
                ...
                items: [
                    {
                        number: "1",
                        title: "Prioritised Lending Products for Launch",
                        text: "Business owners choose banks based on credit access. I advocated for polished lending products at launch over marketplace features. Trade-off: Deprioritised some marketplace integrations. Outcome: Lending products became key differentiators. Customers praised ease of loan applications and transparent credit terms."
                    },
                    {
                        number: "2",
                        title: "Established Consistency Across Teams",
                        text: "With multiple consultant teams working in parallel, I created shared design patterns: Consistent application flows with clear progress indicators, standardised eligibility screens and feedback messaging, and unified visual hierarchy. Implementation: Lightweight pattern library + weekly design reviews. Outcome: Lending products felt cohesive, not like disconnected features bolted together.",
                        image: "/images/coutts-wireframe-progression.svg",
                        caption: "Consistent design patterns across lending products"
                    },
                    {
                        number: "3",
                        title: "Validated Before Building",
                        text: "Rather than build on assumptions, we prototyped and tested: High-fidelity Figma prototypes for each product, moderated sessions with small business owners, and iteration before engineering handoff. Key insight: Users didn't trust AI-driven eligibility assessments without transparency. We redesigned to show clear criteria and next steps. Outcome: Avoided costly rework by catching problems in testing, not production."
                    },
                    {
                        number: "4",
                        title: "Simplified Progress Indicators",
                        text: "Redesigned status updates to be visual, action-oriented, and transparent. Example: 'Your application is under review. You'll hear from us within 2 business days' vs lengthy text descriptions. Outcome: Reduced support calls about application status."
                    }
                ]
            },
            {
                ...
                content: [
                    {
                        subtitle: "Discovery",
                        text: "Discovery phase included: Stakeholder interviews with product, risk, and compliance teams; Competitor analysis of Tide, Starling, and Revolut; Legacy data analysis focused on abandonment points."
                    },
                    {
                        subtitle: "Delivery",
                        text: "Delivery approach included: Weekly design reviews for alignment across teams; Cross-functional workshops with product and engineering; Rapid prototyping → user testing → iteration → validation cycle; Regular stakeholder previews to maintain buy-in and gather feedback."
                    }
                ]
            },
            {
                ...
                content: [
                    {
                        ...
                        text: "Best App Based Business Bank Account (Moneynet) for 4 consecutive years (2022-2025). Best Business Current Account (Moneynet) for 3 years. These awards validated the design decisions and user experience we delivered.",
                        image: "/images/coutts-impact-metrics.svg",
                        caption: "Award-winning impact: 4 years of industry recognition"
                    },
                    {
                        subtitle: "User Feedback",
                        text: "Customers praised: Ease of use and quick account opening (completed in minutes); Helpful features like mobile cheque deposits and cash flow insights; Convenience of completing all banking without branch visits."
                    },
                    {
                        subtitle: "Team Development",
                        text: "100% team retention. All 3 designers grew stakeholder management skills. Built confidence presenting to senior leadership."
                    },
                    {
                        subtitle: "Organisational Impact",
                        text: "Design patterns became reference points for other Kinetic teams. Validation process adopted across HSBC's digital design practice."
                    }
                ]
            },
            {
                ...
                content: [
                    {
                        subtitle: "What Worked",
                        text: "Prioritising consistency created cohesive user experience and faster development. Validated prototyping reduced risk and built stakeholder confidence. Team mentorship created autonomous, high-performing team."
                    },
                    {
                        subtitle: "What I'd Do Differently",
                        text: "Engage technical architects earlier for marketplace API complexity. Document design decisions more formally for faster onboarding. Establish design review cadence from day one rather than ramping up over time."
                    }
                ]
            },
        ]
