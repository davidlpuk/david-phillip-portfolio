...
const caseStudies: readonly CaseStudy[] = [
  {
    slug: "coutts", company: "Coutts", title: "Wealth Management App",
  ...
  },
  {
    ...
    metrics: [{ value: "30s", label: "Analysis", icon: "trending" }, { value: "95%", label: "Coverage", icon: "target" }, { value: "6-8", label: "Avg Issues", icon: "star" }],
    thumbnail: "/images/hero-pattern.png", gradient: "from-blue-500/20 via-purple-500/10 to-transparent",
  },
  {
    slug: "cognism", company: "Cognism", title: "Scaling Design for 4x Growth",
  ...
  {
    slug: "schroders", company: "Schroders", title: "Private Banking Digital Transformation",
